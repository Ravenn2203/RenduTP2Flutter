class WeatherForecastModel {
  ...
  int? message;
  int? cnt;
  List<ListeData>? liste;
  City? city;

  WeatherForecastModel(
      {this.cod, this.message, this.cnt, this.liste, this.city});
  ...
  WeatherForecastModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['list'] != null) {
      liste = <ListeData>[];
      json['list'].forEach((v) {
        liste!.add(new ListeData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cnt'] = this.cnt;
    if (this.liste != null) {
      data['list'] = this.liste!.map((v) => v.toJson()).toList();
    }
    if (this.city != null) {
...
class ListeData {
  ...
  ListeData.fromJson(Map<String, dynamic> json) {
    dt = json['dt'];
